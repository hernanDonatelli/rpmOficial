...
<template>
    ...
    <section id="torneo">
        <div class="hero__champ"
            style="background-image: repeating-linear-gradient(#ffffff8e, rgba(153, 153, 153, 0.761)),url('assets/wall_4.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center left;">
            <div class="row">
                <div class="col-12">
